...
Thus, our main philosophy here is for each of us to make three rules for ourselves to follow every single day and to do so in a way that we can encourage each other -- hence the ***Rules*** listed below.
